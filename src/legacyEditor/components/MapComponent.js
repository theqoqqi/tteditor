...
import Clipboard from '../../editor/util/Clipboard.js';
    ...
    bindListeners() {
        ...
        this.view.setDragNodesListener((x, y) => {
            ...
            if (alignedDraggedX !== this.executedDragX || alignedDraggedY !== this.executedDragY) {
                ...
                let command = new MoveNodesCommand(selectedMapNodes, moveByX, moveByY);
        ...
        this.view.setMoveActionListener((x, y) => {
            ...
            let command = new MoveNodesCommand(selectedMapNodes, moveBy.x * x, moveBy.y * y);
